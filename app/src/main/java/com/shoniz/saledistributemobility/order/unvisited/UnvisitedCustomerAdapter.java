...
public class UnvisitedCustomerAdapter extends RecyclerView.Adapter<UnvisitedCustomerAdapter.ViewHolder> {
    private   List<UnvisitedCustomerModel> customerModels;
    private final OnRequestActionListener listener;
    private List<ReasonModel> reasonModels;
//    private List<UnvisitedCustomerModel> selectedUnvisitedCustomers = new ArrayList<>() ;

    public UnvisitedCustomerAdapter(List<UnvisitedCustomerModel> items, List<ReasonModel> reasonModels, OnRequestActionListener onRequestActionListener) {
        customerModels = items;
        this.listener = onRequestActionListener;
        this.reasonModels = reasonModels;
    }

    public  void setModel(List<UnvisitedCustomerModel> items){
        customerModels = items;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public UnvisitedCustomerModel mItem;
    ...
    public interface OnRequestActionListener {
        void onClick(UnvisitedCustomerModel unvisitedCustomerModel);
    }
...
//            rb[i].setBackgroundDrawable(buttonDrawable);
    ...
    public List<UnvisitedCustomerModel> getUnvisitedList(){
