...
public class PersianCalendar implements Serializable {
    ...
    private static String[] WEEKDAY_NAMES = new String[] { "يکشنبه", "دوشنبه",
            "سه شنبه", "چهارشنبه", "پنجشنبه", "جمعه", "شنبه" };

    private static String[] MONTH_NAMES = new String[] { null, "فروردين",
    ...
    public static String getPersianDate() {
        ...
        return  solarCalendar.getSolarDate();
    }
    ...
    public static String getPersianDateTime() {
        PersianCalendar solarCalendar=new PersianCalendar();
        return  solarCalendar.getSolarDate()+" "+solarCalendar.getTime();
    }
    ...
    public String getTimeFull() {
        ...
        return String.format(loc, "%02d", mDate.getHours()) + ":"
                + String.format(loc, "%02d", mDate.getMinutes()) + ":"
                + String.format(loc, "%02d", mDate.getSeconds());
    }
}
