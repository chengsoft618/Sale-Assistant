...
public class StringHelper {
    ...
    public static String mergeTexts(String t1, String t2, String t3, String t4) {
        return t1 + "  " + t2 + "  " + t3 + "  " + t4;
    }
    public static String mergeTexts(String t1, String t2, String t3) {
        return t1 + "  " + t2 + "  " + t3;
    }
