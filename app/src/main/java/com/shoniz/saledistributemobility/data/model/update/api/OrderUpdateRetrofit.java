...
public class OrderUpdateRetrofit implements IOrderUpdateApi {
    ApiParameter apiParameter;
    CommonPackage commonPackage;


    public OrderUpdateRetrofit(ApiParameter apiParameter, CommonPackage commonPackage) {
    ...
    @Override
    public void orderSync() throws BaseException {
