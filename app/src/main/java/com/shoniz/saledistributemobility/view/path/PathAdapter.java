...
public class PathAdapter extends RecyclerView.Adapter<PathAdapter.ViewHolder> {
    ...
    public PathAdapter(List<PathModel> items, OnPathListener onPathListener) {
        list = items;
        selectableMode = false;
        this.listener = onPathListener;
    }

    public void setModel(List<PathModel> items) {
        this.list = items;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int xx) {
        ...
        final PathModel pathModel = list.get(position);
    ...
    public interface OnPathListener {
        ...
        void onClick(PathModel pathModel);

        void onUpdateClick(List<Integer> selectedIds);

        void onItemCheck(PathModel pathModel);

        void onLongClick(PathModel pathModel);

        void onUpdateClick(PathModel pathModel);
    }
