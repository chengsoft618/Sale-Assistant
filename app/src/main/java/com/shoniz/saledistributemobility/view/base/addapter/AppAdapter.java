package com.shoniz.saledistributemobility.view.base.addapter;
...
public class AppAdapter<T extends IRecyclerViewModel> extends RecyclerView.Adapter<AppAdapter.ViewHolder> {
